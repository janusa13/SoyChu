                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="localizacion-container mb-4 p-3 border rounded">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control @error('localidad') is-invalid @enderror" id="localidad" name="localidad" value="{{ old('localidad') }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control @error('calleYNumero') is-invalid @enderror" id="calleYNumero" name="calleYNumero" value="{{ old('calleYNumero') }}">
                        ...
                        <div class="facturacion-container mb-4 p-3 border rounded">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control @error('nombreFantasia') is-invalid @enderror" id="nombreFantasia" name="nombreFantasia" value="{{ old('nombreFantasia') }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control @error('categoriaIVA') is-invalid @enderror" id="categoriaIVA" name="categoriaIVA" value="{{ old('categoriaIVA') }}">
